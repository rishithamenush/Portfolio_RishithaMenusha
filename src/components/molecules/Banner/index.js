  ...
  return (
    <div className="parent min-h-[100vh] flex flex-col-reverse lg:flex-row items-center justify-between">
      ...
      >
        ...
        <p className="text-neutral max-w-xl mb-6 font-medium translate-y-[-20%] sm:translate-y-[-0%] text-justify">
          I am a versatile software developer with a strong foundation in a
          broad range of programming languages and technologies, including Dart,
          Java, JavaScript, Flutter, React, MySQL, MS SQL, SQLite, Firebase, and
          PHP. My expertise lies in creating dynamic and responsive applications
