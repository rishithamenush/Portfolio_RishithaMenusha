...
const MySkill = () => {
  const languages = [
    ...
    { title: "Java", icon: <SiJava className="text-red-600" /> },
    { title: "Dart", icon: <SiDart className="text-blue-500" /> },
  ];

  const frameworks = [
    { title: "Flutter", icon: <SiFlutter className="text-blue-400" /> },
    { title: ".NET", icon: <SiDotnet className="text-purple-600" /> },
